...
<div class="therichpost-bar therichpost-top therichpost-black therichpost-large" style="z-index:4">
  ...
  <span class="therichpost-bar-item therichpost-right">ADMIN</span>
</div>
<!-- Sidebar/menu -->
<nav class="therichpost-sidebar therichpost-collapse therichpost-white therichpost-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="therichpost-container therichpost-row">
    <div class="therichpost-col s4">
      <img src="{{ asset('images/avatar2.png') }}" class="therichpost-circle therichpost-margin-right" style="width:46px">
    </div>
    <div class="therichpost-col s8 therichpost-bar">
      <span>Bienvenido <strong></strong></span><br>
      <a href="#" class="therichpost-bar-item therichpost-button"><i class="fa fa-envelope"></i></a>
      <a href="#" class="therichpost-bar-item therichpost-button"><i class="fa fa-user"></i></a>
      <a href="#" class="therichpost-bar-item therichpost-button"><i class="fa fa-cog"></i></a>
      <script async src="https://telegram.org/js/telegram-widget.js?14" data-telegram-share-url="https://web.telegram.org/"></script>
...
<i class="fa fa-whatsapp my-float"></i>
  ...
  <div class="therichpost-bar-block">
    <a href="vehicles" class="therichpost-bar-item therichpost-button therichpost-padding-16 therichpost-hide-large therichpost-dark-grey therichpost-hover-black" onclick="therichpost_close()" title="close menu"><i class="fa fa-remove fa-fw"></i>  Close Menu</a>
    <a href="vehicles" class="therichpost-bar-item therichpost-button therichpost-padding therichpost-blue"><i class="fa fa-users fa-fw"></i>  Vehiculo</a>
    <a href="vehicles" class="therichpost-bar-item therichpost-button therichpost-padding"><i class="fa fa-eye fa-fw"></i>  Multas</a>
    <a href="vehicles" class="therichpost-bar-item therichpost-button therichpost-padding"><i class="fa fa-users fa-fw"></i>  Usuarios</a>
    <a href="vehicles" class="therichpost-bar-item therichpost-button therichpost-padding"><i class="fa fa-cog fa-fw"></i>  Configuraciones</a><br><br>
  </div>
</nav>
...
<div class="therichpost-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="therichpost-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> Registros</b></h5>
  </header>
  <div class="therichpost-row-padding therichpost-margin-bottom">
    ...
    <div class="therichpost-quarter">
      <div class="therichpost-container therichpost-teal therichpost-padding-16">
        <div class="therichpost-left"><i class="fa fa-sh-alt therichpost-xxxlarge"></i></div>
        <div class="therichpost-right">
          <h3>23</h3>
        </div>
        <div class="therichpost-clear"></div>
